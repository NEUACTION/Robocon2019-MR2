...
uint16_t DebugUSARTSendBuffCnt2 = 0u;
uint8_t DebugUSARTSendBuf2[DEBUG_USART_SEND_BUF_CAPACITY_2] = {0};
uint8_t DebugUSARTDMASendBuf2[DEBUG_USART_SEND_BUF_CAPACITY_2] = {0};
