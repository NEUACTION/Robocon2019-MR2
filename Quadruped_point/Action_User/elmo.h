...
//ELMO驱动器CAN广播ID号
#define ELMO_BROADCAST_ID_2  (50)
//ELMO驱动器接收ID基址 
#define ELMO_DEVICE_BASEID (0x300)
//ELMO驱动器同时控制两个电机速度接收ID基址 
#define SPEEDCONTROL_BASEID (0x320)
//ELMO驱动器同时控制两个电机位置接收ID基址 
#define POSCONTROL_BASEID (0x340)
//ELMO驱动器接收ID基址 
#define ELMO_DEVICE_BASEID (0x300)
//ELMO驱动器发送ID基址
...
#define SINGLE_POSITION_MODE  (5)  //位置环模式
#define PT_MODE				  (7)  //PT模式
...
* @param  pos:位置命令，单位：脉冲，范围：最大位置限制到最小位置限制2
* @author ACTION
*/
